...
export default function ErrorBoundaryFallback({ error, reset, title = 'Algo salió mal', description }: Props) {
  return (
    <div className="min-h-[50vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full p-8 bg-gray-800/70 border border-red-500/30 rounded-lg text-center animate-fade-in-up">
        ...
        <p className="text-gray-400 text-sm mb-6">{description || 'Ocurrió un error inesperado. Por favor, inténtalo de nuevo.'}</p>
