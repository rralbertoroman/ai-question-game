...
export default function SpectatorView({ gameState }: Props) {
  if (gameState.phase === 'idle') return null;

  return (
    <>
      {/* Spectator badge */}
      <div className="mb-4 p-2 bg-gray-700/30 border border-gray-600/50 rounded-lg flex items-center justify-between">
      ...
      {gameState.phase === 'question' && (
        <div className="animate-fade-in-up">
          ...
          <div className="p-6 bg-gray-800/70 border-2 border-gray-600/30 rounded-lg mb-6 relative overflow-hidden">
